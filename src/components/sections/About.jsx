        ...
        <section id="about" className="py-20 bg-gradient-to-b from-iseo-100 to-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
                    <div>
                        <h3 className="font-display text-3xl font-semibold text-iseo-900 mb-6">
                            La nostra història
                        </h3>
                        <div className="space-y-4 text-iseo-700 leading-relaxed">
                            <p>
                ...
                <div className="bg-white rounded-2xl p-8 shadow-lg border border-iseo-200">
                    <div className="text-center">
                        ...
                        <p className="text-iseo-600 leading-relaxed max-w-4xl mx-auto">
